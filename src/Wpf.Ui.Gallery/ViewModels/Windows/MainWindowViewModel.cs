...
public partial class MainWindowViewModel : ObservableObject {
	...
	[
		...
		new NavigationViewItem("Basic Input", SymbolRegular.CheckboxChecked24, typeof(BasicInputPage))
		{
			MenuItemsSource = new object[]
			{
				...
				new NavigationViewItem(nameof(Ui.Controls.Button), typeof(ButtonPage)),
		...
		new NavigationViewItem("Dialogs & flyouts", SymbolRegular.Chat24, typeof(DialogsAndFlyoutsPage))
		{
			MenuItemsSource = new object[]
			{
				...
				new NavigationViewItem(nameof(Ui.Controls.MessageBox), typeof(MessageBoxPage)),
			}
		},
#if DEBUG
		...
		new NavigationViewItem("Text", SymbolRegular.DrawText24, typeof(TextPage))
		{
			MenuItemsSource = new object[]
			{
				...
				new NavigationViewItem(nameof(Ui.Controls.PasswordBox), typeof(PasswordBoxPage)),
				new NavigationViewItem(nameof(Ui.Controls.RichTextBox), typeof(RichTextBoxPage)),
				new NavigationViewItem(nameof(Label), typeof(LabelPage)),
				new NavigationViewItem(nameof(Ui.Controls.TextBlock), typeof(TextBlockPage)),
				new NavigationViewItem(nameof(Ui.Controls.TextBox), typeof(TextBoxPage)),
			}
		},
	...
	[ObservableProperty]
	private ObservableCollection<Ui.Controls.MenuItem> _trayMenuItems =
	[
		new Ui.Controls.MenuItem { Header = "Home", Tag = "tray_home" },
		new Ui.Controls.MenuItem { Header = "Close", Tag = "tray_close" }
	];
}
