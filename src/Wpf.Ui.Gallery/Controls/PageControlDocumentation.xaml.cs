...
public class PageControlDocumentation : Control {
	...
	public PageControlDocumentation() {
		...
		SetValue(
			...
			new RelayCommand<string>(OnClick)
		);
	}
	...
	private static void SwitchThemes() {
		Appearance.ApplicationTheme currentTheme = Appearance.ApplicationThemeManager.GetAppTheme();

		Appearance.ApplicationThemeManager.Apply(
			currentTheme == Appearance.ApplicationTheme.Light
