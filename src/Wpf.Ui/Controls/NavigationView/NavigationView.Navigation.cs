...
public partial class NavigationView {
	...
	public virtual bool Navigate(Type pageType, object? dataContext = null) {
		if (PageTypeNavigationViewsDictionary.TryGetValue(pageType,
	...
	public virtual bool Navigate(string pageIdOrTargetTag, object? dataContext = null) {
		if (PageIdOrTargetTagNavigationViewsDictionary.TryGetValue(pageIdOrTargetTag,
						out INavigationViewItem? navigationViewItem)) {
			return NavigateInternal(navigationViewItem, dataContext);
		}
		return false;
	...
	private bool TryToNavigateWithoutINavigationViewItem(Type pageType,
	...
	private bool NavigateInternal(INavigationViewItem viewItem,
								object? dataContext = null,
	...
	private object GetNavigationItemInstance(INavigationViewItem viewItem) {
		...
		return _cache.Remember(viewItem.TargetPageType,
	...
	private void OnNavigationViewContentPresenterNavigated(object sender,
