...
public class NavigationViewItem : ButtonBase, INavigationViewItem, IIconControl {
	...
	static NavigationViewItem() {
		DefaultStyleKeyProperty.OverrideMetadata(typeof(NavigationViewItem),
	...
	protected override void OnInitialized(EventArgs e) {
		...
		if (string.IsNullOrWhiteSpace(TargetPageTag) && Content is not null) {
			SetCurrentValue(TargetPageTagProperty,
