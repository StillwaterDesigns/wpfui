...
public class FluentWindow : Window {
	...
	/// </summary>
	private static void OnWindowCornerPreferenceChanged(DependencyObject d,
	...
	/// </summary>
	protected virtual void OnCornerPreferenceChanged(WindowCornerPreference oldValue,
	...
	/// </summary>
	private static void OnExtendsContentIntoTitleBarChanged(DependencyObject d,
															DependencyPropertyChangedEventArgs e) {
		if (d is not FluentWindow window)
			return;
		if (e.OldValue == e.NewValue)
